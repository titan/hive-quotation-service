import { Processor, ProcessorFunction, ProcessorContext, rpcAsync, msgpack_encode_async as msgpack_encode, msgpack_decode_async as msgpack_decode, set_for_response } from "hive-service";
